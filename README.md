...
| `scripts/`           | Bootstrap, setup, teardown, рендериране на wrangler конфига; **ЦАИС ЕОП ingestion** (`load-eop.mjs`, `import.mjs`, `normalize-raw.sql` и съпътстващите SQL стъпки)                                   |
