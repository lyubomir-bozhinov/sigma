...
- [`assistant-composer-ux-plan.md`](assistant-composer-ux-plan.md) — план: поетапното привеждане на полето за писане на асистента към усещането на ChatGPT/Claude (композер, глас, чат полиране).
