...
- **Live-region за stream-натите токени (4.1.3).** Транскриптът е `role="log"` +
  ...
  обявява завършването на хода („Готова е справка: …" / „Отговорът е готов").
- **Reduced motion (2.3.3).** Глобалното правило `@media (prefers-reduced-motion: reduce)` в
  `base.css` нулира анимациите/преходите на панела и избутването на страницата; автоскролът на
  транскрипта е мигновено присвояване, не анимация.
